...
<body>
    ...
    <div id="wrap" class="container">
        ...
        <h4 class="title mt-3">곡 목록</h4>
        <table class="table table-hover text-center">
            <thead>
            <tr>
                <th scope="col" class="font-weight-blod">no</th>
                <th scope="col" class="font-weight-blod">제목</th>
                <th scope="col" class="font-weight-blod">앨범</th>
            </tr>
            </thead>
            <tbody>
